...
function createstyle(cpx) {
    ...
    csslist += "top: 0;right: 0;justify-content: center; align-items: center;transition: all 0.3s ease;text-align:center;}";
    cssname = "";
    ...
    for (var i = 0; i < n; i++) {
        ...
        htmlinner += "   <div class='menucircle" + i + "' id='menu" + i + "-overlay-btn' onclick=('"+cpx[i]+"')>";
        htmlinner += "  <div style='height:30px;width:100px;'></div>";
        htmlinner += "  <i class='fa'>" + cpx[i] + "</i>";
        htmlinner += "  </div>";
